...
if (typeof SpeechRecognition === "undefined") {
	...
	recognition.onresult = event => {
		...
		if (res.isFinal) {
			...
			p.innerHTML = `You : ${text} </br>Briefy : ${asstResponse}`;
